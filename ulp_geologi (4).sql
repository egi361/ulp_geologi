...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 21, 2016 at 04:56 PM
...
(1, 2, 'Chrysanthemum.jpg', '', ',mn,mn,mn,mn,mn,mn,mn,mn,mn,m'),
...
CREATE TABLE `pegawai` (
  ...
  `id_jabatan` int(20) NOT NULL,
  `id_unit_satuan_kerja` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(4, 'Agus Cahyana', NULL, 'Ujung Berung', 'S1', 'laki-laki', 3, 0),
(5, 'Supri', NULL, 'Jatinangor', 'S1', 'laki-laki', 2, 4),
(6, 'asep', NULL, 'cikuda', 'SMP', 'laki-laki', 2, 4);
...
CREATE TABLE `pelaksanaan_kegiatan` (
  `id_pelaksanaan_kegiatan` int(15) NOT NULL,
  `id_usulan_kegiatan` int(15) NOT NULL,
  `tahun_anggaran` int(6) NOT NULL,
  `metode_kegiatan` varchar(200) NOT NULL,
  `pemilihan_penyedia` varchar(200) NOT NULL,
  `id_penyedia` int(15) NOT NULL,
  `id_swakelola` int(15) NOT NULL,
  `nilai_kontrak` double NOT NULL,
  `tanggal_awal_pelaksanaan` date NOT NULL,
...
(1, 4, 2016, 'penyedia', 'lelang_umum', 1, 1, 80000000, '2016-11-21', '2017-11-20'),
(2, 1, 2016, 'swakelola', 'lelang_umum', 1, 2, 100000000, '2016-11-21', '2017-07-19'),
(3, 2, 2017, 'penyedia', 'lelang_umum', 1, 1, 80000000, '2017-01-02', '2018-01-02'),
(4, 3, 2017, 'penyedia', 'lelang_umum', 1, 1, 30000000, '2016-11-28', '2017-01-21'),
(5, 6, 2016, 'swakelola', 'lelang_umum', 1, 5, 80000000, '2016-11-28', '2017-01-12');
...
(1, 'Perusahaan 1', '123456', '0823764876', 'Bandung', 'email@yahoo.com', 'Penanggunng Jawab 1'),
(2, 'Perusahaan 2', '4321', '08767654654', 'Yogyakarta', 'yogya@gmail.com', 'penanggung Jawab 2'),
(3, 'Perusahaan 3', '6543', '0854657657', 'Cileunyi', 'cileunyi@gmail.com', 'penanggung jawab 3');
...
CREATE TABLE `progress_fisik` (
  `id_progress_fisik` int(15) NOT NULL,
  `id_pelaksanaan_kegiatan` int(15) NOT NULL,
  `tanggal_progress_fisik` date NOT NULL,
  `persentase_progress` int(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `progress_fisik`
--

INSERT INTO `progress_fisik` (`id_progress_fisik`, `id_pelaksanaan_kegiatan`, `tanggal_progress_fisik`, `persentase_progress`) VALUES
(1, 1, '2016-11-17', 10),
(2, 1, '2016-12-09', 30),
(3, 1, '2017-05-18', 40),
(4, 5, '2016-12-15', 10);
...
--
-- Table structure for table `progress_keuangan`
--

CREATE TABLE `progress_keuangan` (
  `id_progress_keuangan` int(15) NOT NULL,
  `id_pelaksanaan_kegiatan` int(15) NOT NULL,
...
(1, 1, '2016-11-17', 10000000),
(2, 1, '2016-12-09', 20000000),
(3, 1, '2017-05-18', 20000000),
(4, 5, '2016-12-15', 20000000),
(5, 1, '2016-11-11', 2000000000);
...
--
-- Table structure for table `swakelola`
--

CREATE TABLE `swakelola` (
  `id_swakelola` int(15) NOT NULL,
  `jenis_swakelola` varchar(100) NOT NULL,
  `jenis_jasa` varchar(500) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `swakelola` (`id_swakelola`, `jenis_swakelola`, `jenis_jasa`) VALUES
(5, 'jasa', 'survei'),
(6, 'jasa', 'Penelitian'),
(7, 'barang', 'ATK');
...
(1, 'SBG', 'Sekretariat Badan Geologi', ''),
(2, 'PSDG', 'Pusat Sumber Daya Geologi', ''),
(3, 'PVMBG', 'Pusat Penelitian Vulkanologi Dan Mitigasi Bencana Geologi ', ''),
(4, 'PSDA', 'Pusat Sumber Daya Air Tanah & Geologi Lingkungan', ''),
(5, 'PSG', 'Pusat Survey Geologi', ''),
(6, 'UMG', 'UPT. Museum Geologi', ''),
(7, 'BPPTKG', 'Balai Penyelidikan dan Pengembangan Teknologi Kegunungapian', ''),
(8, 'BKAT', 'Balai Konservasi Air Tanah', '');
...
(79, 'willi', '3a7b7ec4874b4960b1eedcf44cd238f8', 10, '', '', '', 3),
(80, 'agus', '12a8c95298995beaa0d12e2e3efb88e3', 12, '', '', '', 4),
(81, 'supri', '688758bceb7f34242aca0a5cf21b0dfe', 11, '', '', '', 5),
(82, 'asep', 'bee5f0583bf940d15686289b20a0a405', 13, '', '', '', 6);
...
(1, '-', 4, '2016-11-20 03:48:17', 'Pemeliharaan STP dan WTP', 120000000, 110000000, 'disetujui', '-', 'Prioritas', 'APBN', 'Jasa'),
(2, '-', 4, '2016-11-20 03:48:59', 'Pemeliharaan Halaman Gedung Kantor STIN', 100000000, 90000000, 'disetujui', '-', 'Prioritas', 'APBN', 'Konstruksi'),
(3, '-', 4, '2016-11-20 03:49:35', 'Pengadaan Lemari Arsip', 50000000, 40000000, 'disetujui', '-', 'Prioritas', 'APBN', 'Barang'),
(4, '-', 3, '2016-11-20 03:52:05', 'Pengadaan Lemari Arsip', 100000000, 90000000, 'disetujui', '-', 'Prioritas', 'APBN', 'Barang'),
(5, '-', 3, '2016-11-20 03:52:49', 'Pemeliharaan Sistem Acces Control dan Security Door', 50000000, 45000000, 'belum disetujui', '-', 'Prioritas', 'APBN', 'Konstruksi'),
(6, 'survei geologi', 3, '2016-11-21 11:34:35', 'Survei Geologi Daerah A', 100000000, 90000000, 'disetujui', '-', 'Prioritas', 'APBN', 'Jasa');
...
ALTER TABLE `pelaksanaan_kegiatan`
  ADD PRIMARY KEY (`id_pelaksanaan_kegiatan`);
...
--
-- Indexes for table `progress_keuangan`
--
ALTER TABLE `progress_keuangan`
  ADD PRIMARY KEY (`id_progress_keuangan`);
...
--
-- Indexes for table `swakelola`
--
ALTER TABLE `swakelola`
  ADD PRIMARY KEY (`id_swakelola`);
...
ALTER TABLE `usulan_kegiatan`
  ADD PRIMARY KEY (`id_usulan_kegiatan`);
...
--
ALTER TABLE `feature`
  MODIFY `id_feature` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
--
...
--
ALTER TABLE `pelaksanaan_kegiatan`
  MODIFY `id_pelaksanaan_kegiatan` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `penyedia`
--
ALTER TABLE `penyedia`
  MODIFY `id_penyedia` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `progress_fisik`
--
ALTER TABLE `progress_fisik`
  MODIFY `id_progress_fisik` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `progress_keuangan`
--
ALTER TABLE `progress_keuangan`
  MODIFY `id_progress_keuangan` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
...
--
ALTER TABLE `role_feature`
  MODIFY `id_role_feature` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
--
-- AUTO_INCREMENT for table `swakelola`
--
ALTER TABLE `swakelola`
  MODIFY `id_swakelola` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
...
--
ALTER TABLE `unit_satuan_kerja`
  MODIFY `id_unit_satuan_kerja` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
...
--
ALTER TABLE `usulan_kegiatan`
  MODIFY `id_usulan_kegiatan` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
