...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 19, 2016 at 03:11 PM
...
(15, 'Kegiatan Swakelola', 'Pelaksanaan/swakelola', ''),
(16, 'Kegiatan Penyedia', 'Pelaksanaan/penyedia', '');
...
--
ALTER TABLE `feature`
  MODIFY `id_feature` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
--
...
--
ALTER TABLE `role_feature`
  MODIFY `id_role_feature` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
--
