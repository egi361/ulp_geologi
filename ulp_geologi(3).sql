...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 19, 2016 at 11:05 AM
...
CREATE TABLE `progress_fisik` (
  ...
  `persenase_progress` int(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(78, 'egikasep', '6007485776c1af3d2f910d479c295240', 10, '', '', '', 2);
...
(1, 'egi kasep', 2, '2016-11-19 07:43:24', 'membangun rumah', 12000000, 11000000, 'belum disetujui', 'ini adalah keterangan', 'prioritas', 'APBN', 'Konstruksi');
...
--
ALTER TABLE `role_feature`
  MODIFY `id_role_feature` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
--
...
--
ALTER TABLE `usulan_kegiatan`
  MODIFY `id_usulan_kegiatan` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
