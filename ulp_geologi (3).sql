...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 20, 2016 at 04:54 AM
...
(1, 'Instansi Lain', 'Satuan Kerja 1'),
(2, 'Instansi Lain', 'Satuan Kerja 2'),
(3, 'Instansi Penanggung Jawab Anggaran', 'Satuan Kerja 2'),
(4, 'Kelompok Masyarakat', 'Satuan Kerja 3');
...
(1, '-', 4, '2016-11-20 03:48:17', 'Pemeliharaan STP dan WTP', 120000000, 110000000, 'belum disetujui', '-', 'Prioritas', 'APBN', 'Jasa'),
(2, '-', 4, '2016-11-20 03:48:59', 'Pemeliharaan Halaman Gedung Kantor STIN', 100000000, 90000000, 'belum disetujui', '-', 'Prioritas', 'APBN', 'Konstruksi'),
(3, '-', 4, '2016-11-20 03:49:35', 'Pengadaan Lemari Arsip', 50000000, 40000000, 'belum disetujui', '-', 'Prioritas', 'APBN', 'Barang'),
(4, '-', 3, '2016-11-20 03:52:05', 'Pengadaan Lemari Arsip', 100000000, 90000000, 'belum disetujui', '-', 'Prioritas', 'APBN', 'Barang'),
...
--
ALTER TABLE `progress_fisik`
  MODIFY `id_progress_fisik` int(15) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `role_feature`
  MODIFY `id_role_feature` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
--
-- AUTO_INCREMENT for table `swakelola`
--
ALTER TABLE `swakelola`
  MODIFY `id_swakelola` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
...
--
ALTER TABLE `usulan_kegiatan`
  MODIFY `id_usulan_kegiatan` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
