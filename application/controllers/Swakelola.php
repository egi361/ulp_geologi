...
class Swakelola extends CController {
	...
	public function __construct(){
		...
		$this->load->model( array( 'FeatureModel', 'SwakelolaModel') ); 
	}
	...
	public function insert(){
		...
		$this->load->view('swakelola/insert',array('model'=>$model));
	}
...
/* End of file Swakelola.php */
/* Location: ./application/controllers/Swakelola.php */