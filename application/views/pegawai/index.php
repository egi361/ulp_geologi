        <section class="content">
          <div class="box" >
                <div class="box-header with-border">
				  ...
				  <a href="#Pegawai/insert"class="btn btn-primary btn-sm" style="margin-right: 5px;"><i class="fa fa-plus-circle"></i> Add</a>
		...
		$(document).ready(function(){
					...
					$('#TablePegawai').on('click','tbody tr',function(){
						if( $(this).hasClass('selected') ){
							...
							$('#TablePegawai tbody tr').removeClass('selected')
					...
					$("#button-edit").click(function(){
							var id=$("#TablePegawai .selected").attr('id')
							...
							$('#button-edit').addClass('disabled');
							$('#button-delete').addClass('disabled');
							document.location.hash="Pegawai/edit/"+id;
						}
					})
					$("#button-delete").click(function(){
						...
						if(typeof id=='undefined'){
							...
							if(!confirm('Are You Sure Want to Delete This Data?')){
								...
								$('#button-delete').addClass('disabled')
								document.location.hash="Pegawai/delete/"+id;
							}
						}
					})
		})
