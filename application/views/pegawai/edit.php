				<form class="form-horizontal" id="form-pegawai" action="Pegawai/editData/<?=$data->id_pegawai?>" method="POST">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="nama_pegawai" class="col-sm-2 control-label">Nama <span class="required">*</span></label>
                      <div class="col-sm-9">
                        <input type="text" name="nama_pegawai"class="form-control" value="<?=$data->nama_pegawai?>" id="nama_pegawai" placeholder="Name">
                      </div>
                    </div>
					<div class="form-group">
					...
					<div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="pendidikan"class="form-control" id="pendidikan" value="<?=$data->pendidikan?>">
                      </div>
                    </div>
					<div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <select name="jenis_kelamin"class="form-control" id="jenis_kelamin">
							<option <?php $selected = $data->jenis_kelamin == 'laki-laki' ? 'selected' : false; echo $selected; ?> value="laki-laki">Laki-laki</option>
							<option <?php $selected = $data->jenis_kelamin == 'perempuan' ? 'selected' : false; echo $selected;?> value="perempuan">Perempuan</option>
						</select>
                      </div>
                    </div>
					<div class="form-group">
		...
		$(document).ready(function(){
			...
			$('#id_unit_satuan_kerja').select2('val', <?=$data->id_unit_satuan_kerja?>);
			$('#id_jabatan').select2('val', <?=$data->id_jabatan?>);
