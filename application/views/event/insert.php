				<form class="form-horizontal" id="form-event" action="Event/insertData" method="POST">
                  <div class="box-body">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="event_name"class="form-control" placeholder="Event Name">
              					...
              					<div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                      <input type="text" id="date_start" class="form-control" name="date_start" placeholder="Date Start">
                                    </div>
                        </div>
              					<div class="form-group">
...
$(document).ready(function(){
    ...
    $('#date_end').datepicker({'format':'yyyy-mm-dd','language':'id'});
	  ...
	  var editor = CKEDITOR.replace("event_description", {
