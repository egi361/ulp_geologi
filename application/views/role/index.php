        <section class="content">
          <div class="box" >
                <div class="box-header with-border">
				  ...
				  <a href="#Role/insert"class="btn btn-primary btn-sm" style="margin-right: 5px;"><i class="fa fa-plus-circle"></i> Add</a>
		...
		$(document).ready(function(){
					...
					$("#button-edit").click(function(){
						...
						var id=$("#TableRole .selected").attr('id')
						...
						$('#button-edit').addClass('disabled');
						$('#button-delete').addClass('disabled');
						document.location.hash="Role/edit/"+id;
						}
					})
					$("#button-delete").click(function(){
						...
						$('#button-delete').addClass('disabled')
						document.location.hash="Role/delete/"+id;
						}
						}
					})
		})
